...
{{--        </button>--}}
        ...
        <button id="FiltersDropdownButton"
    ...
    <div id="FiltersDropdownContent"
         class="bg-blackSimple border-blackActive shadow-sm border-y pt-3 mt-2 hidden"
    >
...
<script>
    ...
    let FiltersDropdownButton = document.getElementById('FiltersDropdownButton');
    let FiltersDropdownContent = document.getElementById('FiltersDropdownContent');

    FiltersDropdownButton.addEventListener("click", function () {
        if (FiltersDropdownContent.classList.contains('hidden')) {
            FiltersDropdownContent.classList.remove('hidden');
        } else {
            FiltersDropdownContent.classList.add('hidden');
        }
    })
