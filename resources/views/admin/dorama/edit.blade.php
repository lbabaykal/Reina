        ...
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            <div class="relative overflow-x-auto shadow-md">
                <div class="p-5 text-xl font-semibold text-left rtl:text-right text-gray-900 bg-white dark:text-white dark:bg-gray-800">
                    Редактирование дорамы  - {{ $dorama->title_ru }}
                    @if ($message = session('message'))
                        - <span class="text-lime-500">{{ $message }}</span>
                    @endif

                    <a href="{{ route('admin.doramas.episodes.index', $dorama) }}">
                        <button type="button" class="px-4 py-2 bg-orange-400 hover:bg-orange-500 rounded-sm">Эпизоды</button>
                    </a>
                </div>

                <form action="{{ route('admin.doramas.update', $dorama->slug) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    <div class="grid gap-6 mb-6 md:grid-cols-3">
                        ...
                        <div>
                            ...
                            <button id="dropdownCheckboxButton"
                                    ...
                                    class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-hidden focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                    type="button"
                            >
                                Жанры
                            </button>
                            <div id="dropdownGenres" class="z-10 hidden w-48 bg-white divide-y divide-gray-100 rounded-lg shadow-sm dark:bg-gray-700 dark:divide-gray-600">
                        ...
                        <div>
                            ...
                            <div id="dropdownStudios" class="z-10 hidden w-48 bg-white divide-y divide-gray-100 rounded-lg shadow-sm dark:bg-gray-700 dark:divide-gray-600">
                                <ul class="p-3 space-y-3 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownCheckboxButton">
                        ...
                        <div id="dropdownСountries" class="z-10 hidden w-48 bg-white divide-y divide-gray-100 rounded-lg shadow-sm dark:bg-gray-700 dark:divide-gray-600">
                            <ul class="p-3 space-y-3 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownCheckboxButton">
                                    ...
                                    <li>
                                        <div class="flex items-center">
                                            <input id="checkbox-item-{{ $country->id }}"
                                                   ...
                                                   value="{{ $country->id }}"
                                                   name="countries[]"
                                                   @if(old('countries') ? in_array($country->id, old('countries')) : $dorama->countries->contains($country->id))
                                                       @checked(true)
                                                   @endif
                                                   class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
