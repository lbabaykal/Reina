@extends('admin.admin')
@section('title', config('app.name') . ' - Редактирование Студии')
@section('content')
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            <div class="relative overflow-x-auto shadow-md">
                ...
                <form action="{{ route('admin.studios.update', $studio->slug) }}" method="POST">
                    @csrf
                    @method('PATCH')
                    <div class="grid gap-6 mb-6 md:grid-cols-3">
                        <div>
                            <label for="title"
                                ...
                                Русское название @error('title') {{ $message }} @enderror
                            </label>
                            <input id="title"
                                   type="text"
                                   name="title"
