...
export default {
    ...
    methods: {
        getRatingData() {
            ...
            axios
                .get(`/api/animes/${this.slug}/rating`)
                .then((response) => {
        ...
        createOrUpdateAnimeRating() {
            this.dataUserAssessmentLoading = true;
            axios
                .post(`/api/animes/rating`, {
                    slug: this.slug,
        ...
        deleteAnimeRating() {
            this.dataUserAssessmentLoading = true;
            axios
                .delete(`/api/animes/${this.slug}/rating`)
                .then((response) => {
                    this.dataUserAssessment = null;
...
<template>
    ...
    >
        <button
            type="button"
            class="group flex cursor-pointer flex-row items-center rounded-sm bg-gray-600/80 p-2 hover:bg-gray-500"
    ...
    <teleport to="#modals">
        ...
        >
            ...
            >
                <div class="max-w-136 min-w-128 rounded-md bg-white shadow-lg select-none dark:bg-black">
                    ...
                    <div class="flex justify-center border-t border-gray-400 p-2">
                        ...
                        <SuccessButton
                            ...
                            @click="createOrUpdateAnimeRating"
                            :disabledButton="isDataRatingLoading"
                            class="mx-2"
                        />
