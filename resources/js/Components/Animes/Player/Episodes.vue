...
export default {
    ...
    methods: {
        rememberEpisode(episodeId) {
            this.favoriteAnimeStore.rememberEpisode(episodeId);
        },
    ...
    computed: {
        ...
        favoriteEpisodeIndex() {
            return this.mediaPlayerStore.dataEpisodes.findIndex((episode) => episode.id === this.favoriteAnimeStore.dataFavorite.episode_id);
        },
        isDataEpisodes() {
