...
<template>
    <div class="flex aspect-5/7 w-full items-center justify-center text-white select-none">
        <router-link
            ...
            class="group w-95% bg-whiteSimple dark:bg-blackSimple relative aspect-5/7 overflow-hidden rounded-lg transition-all duration-500 hover:w-full hover:drop-shadow-[0_0_12px_rgb(140,0,255)]"
        >
            <PosterImage
                :poster="poster"
                :alt="title"
