                    ...
                    <div v-for="link in dataPagination.links.slice(1, -1)" class="w-12 leading-5">
                        <template v-if="Number(link.label)">
                            <a @click.prevent="changePage(link.label)"
                               ...
                               :class="link.active ? 'bg-gradient-to-tr from-pink-600 to-pink-400 text-whit' : 'hover:bg-gradient-to-tr from-lime-600 to-lime-400 hover:text-white'"
                            >
                                {{ link.label }}
                            </a>
                        </template>
                        ...
                        <template v-if="String('...') === link.label">
                            <a @click.prevent=""
                               class="h-full w-full flex justify-center items-center cursor-pointer rounded-full bg-gradient-to-tr from-blue-600 to-blue-400"
                            >
                                ...
                            </a>
                        </template>
